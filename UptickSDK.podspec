...
Pod::Spec.new do |spec|
  ...
  spec.license      = { :type => "UPTICK", :file => "LICENSE" }
  ...
  spec.author             = { "Uptick" => "nathan@uptick.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/uptick-ads/uptick-ios.git", :tag => "v#{spec.version}" }
